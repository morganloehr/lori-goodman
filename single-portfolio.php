  ...
  <div class="container pt">
    <div class="row mt">
     <div class="col-lg-12">
      ...
      <div class="hidden-instruction"><h5>(Swipe Left And Right To View All)</h5></div>
   ...
   <div class="row">
     <div class="col-lg-12">
      <div class="bottom-post-nav">
        <div class="postnavigation post-next"><?php next_post_link('<i class="fa fa-caret-left"></i> %link'); ?>  </div>  
        <div class="postnavigation post-last"><?php previous_post_link('%link <i class="fa fa-caret-right"></i>'); ?></div>
      </div>
     </div>
   </div>
